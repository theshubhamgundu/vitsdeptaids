...
export const localStudentData = [
  ...
  { ht_no: "23891A7201", student_name: "AEMIREDDY DEEKSHITHA", year: "3rd Year" },
  { ht_no: "23891A7202", student_name: "AEMIREDDY DEEPAK REDDY", year: "3rd Year" },
  { ht_no: "23891A7203", student_name: "ALAMPALLY SAI KUMAR", year: "3rd Year" },
...
export const validateStudentLocally = (hallTicket: string, name: string, year: string) => {
  const student = localStudentData.find(s => 
    s.ht_no === hallTicket && 
