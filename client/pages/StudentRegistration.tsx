...
const StudentRegistration = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (!studentData) {
        setError("Student data not found. Please verify your Hall Ticket Number, Name, and Year match our records exactly.");
        setLoading(false);
        return;
      }

      // Check if user profile already exists
      const { data: existingUser } = await tables.userProfiles()
        ?.select('*')
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Enter your hall ticket number exactly as provided by the college
                </p>
              </div>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link to="/login/student" className="text-blue-600 hover:text-blue-800 font-medium">
                Sign in here
              </Link>
            </div>
          </CardContent>
